...
<!-------------------------------Manage Banner PAGE STARTS HERE--------------------------------------------------------------->
	...
	<tr>
						...
						{ ?>
                            ...
                            <tr>
								<td colspan="2">
								 <input type="checkbox" name="Main" id="Main" value="1"/>Main <input type="checkbox" name="Banglore" id="Banglore" value="1"/>Banglore <input type="checkbox" name="Chennai" id="Chennai" value="1"/>Chennai <input type="checkbox" name="Delhi" id="Delhi" value="1"/>Delhi <input type="checkbox" name="Hyderabad" id="Hyderabad" value="1"/>Hyderabad <input type="checkbox" name="Mumbai" id="Mumbai" value="1"/>Mumbai <input type="checkbox" name="Pune" id="Pune" value="1"/>Pune
                         ...
                         <input type="checkbox" name="Jaipur" id="Jaipur" value="1"/>Jaipur 
						...
						<tr>
							...
							<td class="helpBod">
								<div align="left">
									...
									<a href="manage_sidebanner.php?Id=<?=$BannerList[$i]['Id']?>&Edit=ChangeStatus&Active=<?=$newStatus?>">Change Status</a>
									&nbsp;
									<a href="manage_sidebanner_edit.php?Id=<?=$BannerList[$i]['Id']?>">Edit</a>
									&nbsp;
									<a href="manage_sidebanner.php?delete=<?=$BannerList[$i]['Id']?>" onclick="return confirm('Are you sure to delete this image');">Delete</a>									
								</div>
							</td>
						</tr>
						<tr>
