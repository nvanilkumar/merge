...
<!-------------------------------EDIT FUNCTION PAGE STARTS HERE--------------------------------------------------------------->
<script type="text/javascript" language="javascript">
	function validate(){
		if(document.edit_function.eventfunction.value == ''){
			alert("Please Enter Function");
			document.edit_function.eventfunction.focus();
			return false;
		}
...
<form action="" method="post" name="edit_function" onsubmit="return validate();">
<table width="50%" border="0">
  <tr>
    <td colspan="2"><strong>Edit Function </strong></td>
  </tr>
   <tr>
		<td>Category</td>
  ...
  <tr>
    <td>Function : </td>
    <td><label>
      <input type="text" name="eventfunction" value="<?php echo $function; ?>" maxlength="30" />
