...
<head>
	<title>MeraEvents - Admin Panel - EMail / SMS Management - SMS Report</title>
...
<script language="javascript">
	...
	{
		var strtdt = document.frmSMSReport.txtSDt.value;
		var enddt = document.frmSMSReport.txtEDt.value;
		
		if(strtdt == '')
		{
			alert('Please select Start Date');
			document.frmSMSReport.txtSDt.focus();
			return false;
		}
		else if(enddt == '')
		{
			alert('Please select End Date');
			document.frmSMSReport.txtEDt.focus();
			return false;
		}
...
<div align="center" style="width:100%" class="headtitle">SMS Report</div>
<div align="center" style="width:100%">&nbsp;</div>
	<form name="frmSMSReport" action="" method="post">
		<table width="50%" align="center" class="tblcont">
			<tr>
			  ...
			  <td width="30%" align="left" valign="middle"><input type="submit" name="submit" value="Show SMS Report" onclick="return SEdt_validate();" /></td>
			<tr>
		</table>
	</form>
<?php 
if(count($SMSReport) > 0) 
{ 
?>
<table width="90%" align="center" class="sortable">
	<tr>
	  <td width="25%" align="left" valign="middle" class="tblcont1">Name</td>
	  <td width="25%" align="left" valign="middle" class="tblcont1">Mobile Number</td>
	...
	<?php 
		for($i = 0; $i < count($SMSReport); $i++)
		{
	?>
	<tr>
		<td align="left" valign="middle" class="helpBod" height="25"><?=$SMSReport[$i]['name']?></td> 	
		<td align="left" valign="middle" class="helpBod"><?=$SMSReport[$i]['mobile']?></td>
		<td align="left" valign="middle" class="helpBod"><?=$SMSReport[$i]['type']?></td>
		<td align="left" valign="middle" class="helpBod"><?=$SMSReport[$i]['cts']?></td>
	</tr>
	<?php 
		} 
	?>
...
else if(count(isset($SMSReport)) == 0) 
{
?>
