...
<!-------------------------------Manage Banner PAGE STARTS HERE--------------------------------------------------------------->
					...
					<div align="center" style="width:100%" class="headtitle">Manage <?php echo ucfirst($btype); ?> Banner - Edit Banner Information</div>
					<div align="center" style="width:100%">&nbsp;</div>
					...
					<form name="frmEditBanner" action="" method="post" enctype="multipart/form-data">
						...
						<table width="100%" cellpadding="1" cellspacing="2">
                            ...
                            <tr>
								...
								<td width="75%"><?php echo ucfirst($btype); ?></td>
							</tr>
							...
							<tr>
								...
								<td width="75%">
									<input type="text" name="txtTitle" id="txtTitle" value="<?=$BannerList[0]['Title']?>"  size="50"  />
								</td>
							</tr>
                                                <tr>
								<td width="25%">
									<b>Event Id &nbsp;<font color="#FF0000">*</font>&nbsp;:</b>
								</td>
								<td width="75%">
									<input type="text" name="EventId" id="EventId" value="<?=$BannerList[0]['EventId']?>" maxlength="50" size="50"  />
								</td>
							</tr>
	  ...
	  <td width="72%" align="left" valign="middle"><strong>End Date</strong>:&nbsp;
	    <input type="text" name="txtEDt" id="txtEDt" value="<?php echo date('d/m/Y',strtotime($BannerList[0]['EndDt'])); ?>" size="8" onfocus="showCalendarControl(this);" /></td>
							...
							<tr>
								...
								<td width="75%">
									<img src="<?=_HTTP_CDN_ROOT.$BannerList[0]['FileName']?>" height="200" width="772"></img><br /><br />
							...
							<tr>
                             ...
                             <tr>
								<td colspan="2">
								 <input type="checkbox" <? if($BannerList[0]['Main']==1){?> checked="checked" <? }?> name="Main" id="Main" value="1"/>Main
                                 <input type="checkbox"  <? if($BannerList[0]['Banglore']==1){?> checked="checked" <? }?> name="Banglore" id="Banglore" value="1"/>Banglore 
                                 <input type="checkbox"  <? if($BannerList[0]['Chennai']==1){?> checked="checked" <? }?> name="Chennai" id="Chennai" value="1"/>Chennai 
                                 <input type="checkbox"  <? if($BannerList[0]['Delhi']==1){?> checked="checked" <? }?> name="Delhi" id="Delhi" value="1"/>Delhi 
                                 <input type="checkbox"  <? if($BannerList[0]['Hyderabad']==1){?> checked="checked" <? }?> name="Hyderabad" id="Hyderabad" value="1"/>Hyderabad 
                                 <input type="checkbox"  <? if($BannerList[0]['Mumbai']==1){?> checked="checked" <? }?> name="Mumbai" id="Mumbai" value="1"/>Mumbai 
                                 <input type="checkbox"  <? if($BannerList[0]['Pune']==1){?> checked="checked" <? }?> name="Pune" id="Pune" value="1"/>Pune 
                                 <input type="checkbox"  <? if($BannerList[0]['Kolkata']==1){?> checked="checked" <? }?> name="Kolkata" id="Kolkata" value="1"/>Kolkata 
                                 <input type="checkbox"  <? if($BannerList[0]['AllCities']==1){?> checked="checked" <? }?> name="AllCities" id="AllCities" value="1"/>AllCities 
                                 <input type="checkbox"  <? if($BannerList[0]['OtherCities']==1){?> checked="checked" <? }?> name="OtherCities" id="Goa" value="1"/>OtherCities 
							...
							<tr>
								<td width="25%">&nbsp;</td>
								<td width="55%">
									<input type="Submit" name="Update" value="UpdateBanner" onclick="return val_editBanner();" />&nbsp;<input type="button" name="Cancel" value="Cancel" onclick="javascript:window.location='manage_newyear_banner.php?btype=<?php echo $btype; ?>'" />
								</td>
							</tr>
						</table>
