                    ...
                    <form name="frmEditImages" action="" method="post" enctype="multipart/form-data">
                        ...
                        <table width="100%" cellpadding="1" cellspacing="2">
                            ...
                            <tr>
                                ...
                                <td width="75%">
                                    <img src="<?=_HTTP_SITE_ROOT.$GalleryImagesList[0]['FileName']?>" /><br /><br />
                                    <input type="file" name="fileGalleryImage" id="fileGalleryImage" maxlength="100" title="Size should be 772 px X 200 px" value="" size="50"  />
                                </td>
                            </tr>
                            <!--<tr>
                                <td width="25%">
                            ...
                            <tr>
                                <td width="25%">&nbsp;</td>
                                <td width="55%">
                                    <input type="Submit" name="Update" value="UpdateImages" onclick="return val_editImages();" />&nbsp;<input type="button" name="Cancel" value="Cancel" onclick="javascript:window.location='manage_PopEvents.php'" />
                                </td>
                            </tr>
                        </table>
