...
<body style="background-image: url(images/background.gif); background-repeat:repeat-x; margin-top: 0px; margin-left: 0px; margin-right:0px; padding:0px">
  ...
  <tr>
    ...
    <tr><td align="center" style="line-height:30px; padding:11px 0 0 141px; text-decoration:underline" >Events Count By Category</td></tr>
	<tr>
...
<table     border='1' cellpadding='0' cellspacing='0' >
 ...
 for($i = 0; $i < count($TransactionRES); $i++)
	    { ?>
        <td style="line-height:30px; padding:5px; width:100px;"><?php echo $TransactionRES[$i]['CatName'];?></td>
        <?php }?>
         <td style="line-height:30px; padding:5px; width:100px;">Other</td>
        </tr>
  <tr><td style="line-height:30px; padding:5px;"><strong>TotalByCategory</strong></td>
  <?php
 for($i = 0; $i < count($TransactionRES); $i++)
	    { ?>
        <td  style="line-height:30px; padding:5px;"><?php echo $TransactionRES[$i]['ecount'];?></td>
        <?php
$tot=$tot+$TransactionRES[$i]['ecount'];		 }?>
         ...
         <td colspan="<?php echo count($TransactionRES)?>">&nbsp;</td>
