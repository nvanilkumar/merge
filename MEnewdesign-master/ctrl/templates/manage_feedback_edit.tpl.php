...
<!-------------------------------Manage Banner PAGE STARTS HERE--------------------------------------------------------------->
					...
					<div align="center" style="width:100%" class="headtitle">Manage Testimonials - Edit Client Testimonials Information</div>
					<div align="center" style="width:100%">&nbsp;</div>
					...
					<form name="frmEditBanner" action="" method="post" enctype="multipart/form-data">
						<input type="hidden" name="editid" value="<?=$ResTestQuery[0]['Id']?>" />
                                            <input type="hidden" name="editlogo" value="<?=$ResTestQuery[0]['logo']?>" />
						
						<table width="90%" cellpadding="1" cellspacing="2">
							<tr>
								<td width="100%" colspan="2"><b>Edit Testimonials</b></td>
							</tr>
							<tr>
							...
							<tr>
                             ...
                             <tr>
								...
								<td width="75%">
									<input type="text" name="txtcName" id="txtcName" value="<?=$ResTestQuery[0]['CompanyName']?>"maxlength="50" size="50" />
								</td>
							</tr>
                            <tr>
								<td width="25%">
							...
							<tr>
                               ...
                               <tr>
								...
								<td width="75%"><img src="<?=_HTTP_SITE_ROOT."/meraevents_dev/".$ResTestQuery[0]['logo']?>" ></img><br /><br />
									<input type="file" name="fileLogoImage" id="fileLogoImage" maxlength="100"  size="50" />
								</td>
							</tr>
							<tr>
								<td width="25%">&nbsp;</td>
								<td width="55%">
									<input type="Submit" name="Update" value="UpdateTestimonials" />
								</td>
							</tr>
							<tr>
								<td width="100%" colspan="2">&nbsp;</td>
