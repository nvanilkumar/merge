...
<table width="50%" >
      <tr>
        <td colspan="2" class="headtitle" align="center"><strong>Event Category</strong> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><table width="100%" class="sortable-onload-3r no-arrow colstyle-alt rowstyle-alt paginate-20 max-pages-3 paginationcallback-callbackTest-calculateTotalRating sortcompletecallback-callbackTest-calculateTotalRating">
		  ...
		  ?>
          <tr>
            <td class="helpBod"><?php echo $categoryList[$i]['name'];	?></td>
			<td class="helpBod"><?php echo $categoryList[$i]['order'];	?></td>
			<td class="helpBod"><?php echo $categoryList[$i]['status']? 'Active' : 'Inactive'; ?></td>
			<td class="helpBod"><?php echo $categoryList[$i]['featured']? 'Featured' : 'Not Featured'; ?></td>
            <td class="helpBod"><a href="category_edit.php?id=<?=$categoryList[$i]['id']?>">Edit</a></td>
      ...
      <tr>
            <td><label>
          <div align="right">
            <input type="button" name="Add" value="Add" onClick="document.location='addcategory.php'">
            </div>
        </label></td>
        <td><label>
          <div align="right">
