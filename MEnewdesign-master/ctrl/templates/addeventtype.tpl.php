...
<script type="text/javascript" language="javascript">
	function validate()
	{
		if(document.event_type.txtEventType.value == "")
		{
			alert("Please Enter Event Type To Be Added");
			document.event_type.txtEventType.focus();
			return false;
		}	
...
<form action="" method="post" name="event_type" onSubmit="return validate()">
	<table width="50%" border="0">
	  <tr>
		<td colspan="2"><strong>Add Event Type </strong></td>
	  </tr>
	  <tr>
		<td>Event Type  : </td>
		<td><label>
		  <input type="text" name="txtEventType" maxlength="50" />
		</label></td>
	  </tr>
      <tr>
    <td>Display Order : </td>
