                                ...
                                <div id="divMainPage" style="margin-left: 10px; margin-right:5px">
                                    ...
                                    <div align="center" style="width:100%">
                                        ...
                                        <table width="60%" border="0" cellpadding="3" cellspacing="3">
                                            <tr>
                                                <td align="center" colspan="2" valign="middle" class="headtitle"><strong>Check Signup Status</strong> </td>
                                            </tr>


                                            <tr id="success_tr" ><td colspan="2" valign="middle" class="headtitle"><b style="color:#090"> <?=$capture_status ?><BR/>
                                                   <?= $refund_status ."<br/>".
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <form method="post" action=""  name="ebs_form" id="ebs_form" enctype="multipart/form-data">
                                                        <fieldset>
                                                            <legend>Details</legend>
                                                            <table>
                                                                <tr><td> EBS document</td> 
