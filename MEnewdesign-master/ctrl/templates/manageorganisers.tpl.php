...
<div>
	<form name="frmorgsearch" action="listorganisers.php" method="post" onSubmit="return valid();">
		<table width="100%" cellpadding="0" cellspacing="5" style="padding-left:20px;">
			<tr>
				<td colspan="4" align="center" class="headtitle">Search Organisers</td>
			</tr>
			<tr>
			  <td colspan="4">&nbsp;</td>
		  </tr>
			...
			<tr>
			  <td>&nbsp;</td>
				...
				?>	<option value="<?=$dtlCities[$i]['City']?>"><?=$dtlCities[$i]['City']?></option>
				<?php	
					}
				?>
					</select>
