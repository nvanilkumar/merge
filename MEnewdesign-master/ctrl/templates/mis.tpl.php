		...
		<tr>
			<td align="center">
				<table width="60%" cellpadding="0" cellspacing="0"  style="border:thin; border-color:#006699; border-style:solid;">
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td align="left" style="padding-left:10px;"><a href="delgreport.php" class="lnk">Registered Delegate Report</a></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td align="left" style="padding-left:10px;"><a href="orgreport.php" class="lnk">Organiser Reports</a></td>
					</tr>
					<tr><td >&nbsp;</td></tr>
				</table>
			</td>
