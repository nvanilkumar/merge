...
<table width="50%">
      ...
      <tr>
        <td colspan="2"><table width="100%" class="sortable">
          <thead>
          <tr>
            <td class="tblcont1"><strong>Event Type </strong></td>
		  ...
		  ?>
          <tr>
            <td class="helpBod"><?php echo stripslashes($EventTypeList[$i]['EventType']); ?></td>
             <td class="helpBod"><?php echo stripslashes($EventTypeList[$i]['DispOrder']); ?></td>
             <td class="helpBod"><a href="eventtype_edit.php?id=<?php echo $EventTypeList[$i]['Id']; ?>">Edit</a></td>
      ...
      <td><label>
          <div align="right">
            <input type="button" name="Add" value="Add" onClick="document.location='addeventtype.php'">
            </div>
        </label></td>
        <td><label>
          <div align="right">
