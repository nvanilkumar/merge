...
<table width="50%">
      <tr>
        <td colspan="2" class="headtitle" align="center"><strong>Country Management</strong> </td>
      </tr>
      <tr>
        ...
        <td colspan="2"><table width="100%" class="sortable">
          ...
          <tr>
            <td class="tblcont1"><strong>Country</strong> </td>
             <td class="tblcont1"><strong>Short name</strong> </td>
             <td class="tblcont1"><strong>Order</strong> </td>
		  ...
		  ?>
          <tr>
            <td class="helpBod"><?php echo $CountryList[$i]['name'];	?></td>
            <td class="helpBod"><?php echo $CountryList[$i]['shortname']; ?></td>
            <td class="helpBod"><?php echo $CountryList[$i]['order']; ?></td>
            <td class="helpBod"><?php echo ($CountryList[$i]['status'] == 1) ? 'Active' : 'Inactive'; ?></td>
            <td class="helpBod"><?php echo ($CountryList[$i]['featured'] == 1) ? 'Featured' : 'Not Featured'; ?></td>
            <td class="helpBod"><a href="country_edit.php?id=<?=$CountryList[$i]['id']?>">Edit</a></td>
            <td class="helpBod"><label>
              <input type="checkbox" name="country[]" value="<?=$CountryList[$i]['id']?>" />
            </label></td>
          </tr>
		  <?php 
			  }
