...
<script language="javascript">
    /*function TransStatus(sId)
    {
        ...
        window.location="eventsbyenddate.php?value=change&txtSDt="+strtdt+"&CityId="+CityId;
    }*/
    function submitFilter()
        {
            if (document.frmEofMonth.txtSDt.value == "") {
                ...
                var targetPage = "eventsbyenddate.php?" + reqTxtSDt + "" + reqCountry + "" + reqState + "" + reqCity;
...
<table width="98%" border="0" cellpadding="3" cellspacing="3">
  ...
  <tr><td colspan="6"><table width="50%" align="left" class="tblcont">
	<tr>
	  <td width="35%" align="left" valign="middle">Event End Date:&nbsp;<input type="text" name="txtSDt" value="<?php echo $SDt; ?>" size="8" onfocus="showCalendarControl(this);" /></td>
	 
	 
	<tr>
</table></td></tr>
<tr> <td width="19%" align="left" valign="middle"><input type="submit" name="submit" value="Show report" onclick="return submitFilter();" /></td><td><strong>Total Events</strong> :<?php echo $rows;?></td>
</tr>
  <tr>
    <td colspan="6"><table width="100%" border="1" cellspacing="2" cellpadding="2">
  <tr>
   <td width="4%" align="center"><strong>S No</strong></td>
    <td width="44%" align="center"><strong>Events</strong></td>
    <td width="8%" align="center"><strong>Preview</strong></td>
  ...
  <?php }?>
  <tr><td colspan="5" align="right"><?php echo $pagination?></td></tr>
