...
{                                       //$to="samuel.phinny@qison.com";
                                       ...
                                       // $Message=$_POST['message'];
                                        $subject='"Have a Solution" mail from ticket sales accelerator';
					$cc=NULL;
					$replyto=NULL;
					$conent=NULL;
					$filename=NULL;
...
<body class="SolutionsBG">
<!--class="SolutionsBG"--> 
<!-- Start home -->
<header>
  <div class="navbar">
    <div class="container"> <a class="navbar-brand" href="<?php echo _HTTP_SITE_ROOT ?>"><img src="<?php echo $microsite_path;?>/img/meraevents-logo.png" alt="" /> </a> </div>
  </div>
</header>
<!-- End header --> 
...
<section id="contact">
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
        <h1 class="toptext">I have a better solution</h1>
        <form id="contactform" action="solution.php" method="post" class="validateform" name="leaveContact">
          ...
          <ul class="listForm">
            ...
            <li>
              <label>Your solution <span>&#40; Required &#41;</span></label>
              <textarea class="form-control" rows="9" name="message" data-rule="required" data-msg="Please write something for us"></textarea>
              <div class="validation"></div>
            </li>
            <li>
              <input type="submit" value="Send message" class="btn btn-red btn-lg btn-block" name="Submit" />
            </li>
          </ul>
        </form>
      </div>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-lg-12"> <span class="copyright">2014 &copy; Copyright <a href="<?php echo _HTTP_SITE_ROOT ?>">Versant Online Solutions Pvt.Ltd.</a></span> </div>
    </div>
  </div>
</footer>
<!-- End footer --> 
