(function(){
	...
	// ****** GOOGLE MAP *******
	var map;
	var brooklyn = new google.maps.LatLng(17.4468, 78.3447);				
	...
	function initialize() {				
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(19.0176147, 72.8561644),
		...
		var myLatLng = new google.maps.LatLng(19.0176147, 72.8750100);
