...
/* jQuery('#qcMenuTrig').click(function()
{
$(this).find('a:visible').next('#primary-nav').fadeIn();
var className = $('#primary-nav li').attr('class');
alert(className);
}); */


$('#qcMenuTrig').click(function(e){ 

    $(this).fadeIn('a:visible', function(){
...
$('#primary-nav li').click(function(e){   
   $('#primary-nav li').attr('data-toggle', 'collapse');
