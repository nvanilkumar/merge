  ...
  <nav class="navbar yamm navbar-default">
    <div class="container">
      <div class="navbar-header">
		...
		<img src="<?=_HTTP_SITE_ROOT;?>/newyear/assets/img/meraevents-logo-y.svg" />
    ...
    <div class="row">
      <div class="photo-filter">
        <div class="container"><!-- <h1 class="MainText">Feet thumping music</h1><br> -->
		  ...
		  ?>
          <h1>New Year Events 2016 IN <?php echo $SeoCity;?></h1><br>
          <h5>Search Filter:</h5>
          <ul>
            <li>
...
<script type="application/ld+json">
    {  "@context" : "http://schema.org",
       "@type" : "WebSite",
       "name" : "MeraEvents",
       "alternateName" : "MeraEvents New Year Events in <?php echo $SeoCity;?>",
