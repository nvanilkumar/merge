...
$.ajax({
		url: "<?=_HTTP_SITE_ROOT;?>/newyear/load-grid_list.php",
		type: "GET",
		data: datas,
...
function lookup(inputString) {
		if(inputString.length == 0) {
			...
			$.post("<?=_HTTP_SITE_ROOT;?>/newyear/get_list.php", {queryString: ""+inputString+""}, function(data){
				if(data.length >0) {
					$('#suggestions').show();
  ...
  <nav class="navbar yamm navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?=_HTTP_SITE_ROOT;?>/newyear/All"><div class="newlogo logo"> 
		<!--img src="<?=_HTTP_CF_ROOT;?>/newyear/assets/img/meraevents-logo-y.svg" />-->
		<img  src="<?php echo $microsite_path;?>/assets/img/meraevents-logo-y.svg" />
    ...
    <div class="row">
      <div class="photo-filter">
        <div class="container"><!-- <h1 class="MainText">Feet thumping music</h1><br> -->
		  ...
		  ?>
          <h1>New Year Events 2016 IN <?php echo $city; ?></h1><br>
          <h5>Search Filter:</h5>
          <ul>
            <li>
			...
			<?php if(strlen($SearchCurrentResult[$i]['Title'])>100){ echo substr(stripslashes($SearchCurrentResult[$i]['Title']),0,100).".."; }else{ echo $SearchCurrentResult[$i]['Title']; } ?>
              <p>@ <?php echo substr(stripslashes($SearchCurrentResult[$i]['Venue']),0,60); ?></p></a> </div>
                ...
                <div class="row Errordiv-holder">
                    <div class="col-lg-12">
                         <p  class="ErrorResults">Sorry, We did not find any events. <a href="<?php echo _HTTP_SITE_ROOT; ?>/newyear/All">Click Here</a> to load all Events.</p>
                    </div>
                </div>
                <?php 
		 	}
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        ...
        <div class="row"> 
           <ul class="sitemap">
            <li><a href="All">New Year Parties 2016 All India</a></li>
  ...
  /*$.noConflict();*/
    $(document).ready(function(){
		$("#SearchText").autocomplete({
            ...
            $.ajax({
                url: '<?=_HTTP_SITE_ROOT;?>/newyear/get_list.php',
                type: "POST",
                dataType: "json",
