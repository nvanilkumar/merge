...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/images/content/temp'; // Relative to domain name	
	//$config['img_path'] = '/Meraevents2.3/Meraevents/dashboard/tinymce/js/jbimages'; // Relative to domain name
