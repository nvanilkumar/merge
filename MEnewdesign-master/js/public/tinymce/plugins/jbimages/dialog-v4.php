...
<body>
	<form class="form-inline" id="upl" name="upl" action="imageUpload.php" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
	...
	<iframe id="upload_target" name="upload_target" src="blank.php" ></iframe>
</body>
</html>