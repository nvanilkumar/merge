...
class Validator
{
    ...
    /**
     * To check the dashboard  validations
     * @return boolean
     */
    public function dashboardValidations()
    {
        $this->expectInt('user_id');
        return true;
    }
    ...
    /**
     * To check the event  validations
     * @return boolean
     */
    ...
    /**
     * To check comment validations
     * @return boolean
     */
    public function markCommentValidations()
    {
        $this->expectInt('comment_id');
    ...
    public function dateCompare($st_date, $en_date2)
    {
        ...
        if ($start_date > $end_date) {
            throw new InvalidArgumentException('end date should be grater than start date', 10054);
        }
        return true;
    }
